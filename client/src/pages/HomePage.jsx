    ...
    <div style={backgroundImage}>
      ...
      <div className="w-[100vw] h-40 bg-transparent border-b-white border-2 top-0 flex items-center justify-between p-5">
        ...
        <div className="flex gap-20 text-white text-2xl font-bold pr-10">
          ...
          <button className="w-40 h-20 rounded-full bg-red-400 items-center justify-center cursor-pointer duration-500 hover:bg-red-500 hover:scale-95 transition-all">
            Sign Up
          </button>
        </div>
      </div>
      ...
      <div className="absolute left-10 top-80">
        ...
        <div className="flex gap-10 mt-10">
          ...
          <button className="w-60 h-24 rounded-full bg-red-400 items-center justify-center cursor-pointer duration-500 hover:bg-red-500 hover:scale-95 transition-all text-white text-2xl font-bold">
            Sign Up
          </button>
        </div>
      </div>
